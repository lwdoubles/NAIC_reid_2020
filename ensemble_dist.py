...
query_1 = np.load('./contest_10_9_2/query_path_1.npy')
gallery_1 = np.load('./contest_10_9_2/gallery_path_1.npy')
print(len(query_1), len(gallery_1))
query_2 = np.load('./contest_10_9_2/query_path_2.npy')
gallery_2 = np.load('./contest_10_9_2/gallery_path_2.npy')
print(len(query_2), len(gallery_2))
...
distmat_1 = 1.2 * np.load('./contest_10_9_2/distmat_1.npy')
distmat_1 += 0.9 * np.load('./contest_10_12_1/distmat_1.npy')
distmat_1 += 1.2 * np.load('./contest_10_12_2/distmat_1.npy')
...
distmat_2 = 1.2 * np.load('./contest_10_9_2/distmat_2.npy')
distmat_2 += 0.9 * np.load('./contest_10_12_1/distmat_2.npy')
distmat_2 += 1.2 * np.load('./contest_10_12_2/distmat_2.npy')
